 ...
 * {@link com.vaadin.spring.internal.ViewCache}. The strategy pattern is used to
 * make it easier to mock the {@link com.vaadin.spring.internal.ViewScopeImpl
 * view scope} while doing testing. For internal use only.
 *
